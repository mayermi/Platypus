...
var IdeaComponent = (function () {
    ...
    IdeaComponent.prototype.getAbsoluteDate = function (date) {
        return index_3.formatDate.absolute(date);
    };
    IdeaComponent.prototype.getRelativeDate = function (date) {
    ...
    IdeaComponent.prototype.saveModification = function () {
        ...
        this.ideaService.createModificationForIdea(this.idea, this.modification)
            ...
            _this.idea.modifications.unshift(modification);
            _this.openModifications.unshift(modification);
        });
    };
    IdeaComponent.prototype.ngOnInit = function () {
        ...
        this.route.params
            ...
            _this.ideaService.getStatesForIdea(idea).then(function (states) {
                idea.states = states;
                _this.currentState = states.sort(function (stateA, stateB) { return stateB.phase.number - stateA.phase.number; })[0];
            });
        });
    };
